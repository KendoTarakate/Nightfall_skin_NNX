...
public class SkinChangerScreen extends Screen {
    ...
    private int selectedResolution = 1024;
                ...
                if (selectedPath != null && !selectedPath.isEmpty()) {
                    ...
                    client.execute(() -> {
                        if (isValidSkinFile(selectedFile)) {
                            ...
                            statusMessage = "Invalid skin file! Must be PNG (64x64 to 1024x1024)";
                            statusColor = 0xFF0000;
                        }
                    });
                } else {
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        ...
        if (!draggedFiles.isEmpty()) {
            ...
            if (file.exists() && isValidSkinFile(file)) {
                ...
                statusMessage = "Invalid file! Must be PNG (64x64 to 1024x1024)";
                statusColor = 0xFF0000;
            }
            draggedFiles.clear();
        }
    ...
    private void playRandomSkinChangeSound() {
        if (client.player != null && client.world != null) {
            ...
            net.minecraft.sound.SoundEvent sound = Math.random() < 0.5 ?
                    ModSounds.SKIN_CHANGE_1.get() : ModSounds.SKIN_CHANGE_2.get();
